...
//        mTextView.setBackgroundResource(R.drawable.shape_verification_check_btn); //设置按钮为灰色，这时是不能点击的
...
//        mTextView.setTextColor(mContext.getResources().getColor(R.color.text_gray));
//        mTextView.setClickable(true);//重新获得点击
//        mTextView.setBackgroundResource(R.drawable.shape_verification_code); //还原背景色
    }
}
