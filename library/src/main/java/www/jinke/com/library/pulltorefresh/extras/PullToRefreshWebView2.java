 ...
 *******************************************************************************/
package www.jinke.com.library.pulltorefresh.extras;
...
import www.jinke.com.library.pulltorefresh.PullToRefreshWebView;
 ...
 * {@link WebView#getScrollY()} doesn't back_image correct values.</li>
 ...
 * can happen, and back_image the result via the callback mechanism. An example can
 * be seen below:
 * <p/>
 * 
 * <pre>
