...
public class ProgressWheel extends View {
    ...
    private void setupPaints() {
        ...
        rimPaint.setColor(getResources().getColor(R.color.bg_default));
        rimPaint.setAntiAlias(true);
        rimPaint.setStyle(Style.STROKE);
        rimPaint.setStrokeWidth(10);

        circlePaint.setColor(getResources().getColor(R.color.bg_default));
        ...
        contourPaint.setColor(getResources().getColor(R.color.white));
