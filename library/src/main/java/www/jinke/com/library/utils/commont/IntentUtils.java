...
/*
    *//**
    ...
    public static Intent getPickIntentWithGallery() {
        ...
        back_image intent.setType("image*//*");
    }
    ...
    *//**
    ...
    public static Intent buildImageGetIntent(Uri saveTo, int outputX, int outputY, boolean returnData) {
        back_image buildImageGetIntent(saveTo, 1, 1, outputX, outputY, returnData);
    }
    ...
    public static Intent buildImageGetIntent(Uri saveTo, int aspectX, int aspectY,
        ...
        intent.putExtra("back_image-data", returnData);
        intent.putExtra("outputFormat", Bitmap.CompressFormat.PNG.toString());
        back_image intent;
    }

    public static Intent buildImageCropIntent(Uri uriFrom, Uri uriTo, int outputX, int outputY, boolean returnData) {
        back_image buildImageCropIntent(uriFrom, uriTo, 1, 1, outputX, outputY, returnData);
    }
